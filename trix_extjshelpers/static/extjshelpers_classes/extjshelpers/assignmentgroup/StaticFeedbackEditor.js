 ...
 */
Ext.define('trix_extjshelpers.assignmentgroup.StaticFeedbackEditor', {
    extend: 'trix_extjshelpers.assignmentgroup.StaticFeedbackInfo',
    ...
    config: {
         ...
         * A {@link trix_extjshelpers.SingleRecordContainer} for GradeEditor Config.
         */
