Ext.define('trix_extjshelpers.assignmentgroup.DeliveriesGroupedByDeadline', {
    ...
    requires: [
        ...
        'trix_extjshelpers.assignmentgroup.DeliveriesGrid',
        'trix_extjshelpers.assignmentgroup.DeliveriesPanel',
        'trix_extjshelpers.assignmentgroup.CreateNewDeadlineWindow'
    ],
...
//    style: 'border-right: 1px solid #ddd !important; border-top: 1px solid #ddd !important;',
    ...
    */
    ...
    loadAllDeadlines: function() {
        ...
        this.addLoadMask();
        this.removeAll();
        var deadlinestore = trix_extjshelpers.RestFactory.createStore(this.role, 'Deadline', {
            filters: [{
