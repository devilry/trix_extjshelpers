 ...
 */
Ext.define('trix_extjshelpers.assignmentgroup.AssignmentGroupOverview', {
    extend: 'Ext.container.Container',
    alias: 'widget.assignmentgroupoverview',
    cls: 'widget-assignmentgroupoverview devilry_subtlebg',
    requires: [
        'trix_extjshelpers.assignmentgroup.StaticFeedbackInfo',
        'trix_extjshelpers.assignmentgroup.StaticFeedbackEditor',
        'trix_extjshelpers.assignmentgroup.AssignmentGroupTitle',
        'trix_extjshelpers.assignmentgroup.AssignmentGroupTodoListWindow',
        'trix_extjshelpers.assignmentgroup.DeliveriesGroupedByDeadline',
        'trix_extjshelpers.assignmentgroup.IsOpen',
        'trix_extjshelpers.RestFactory',
        'devilry.administrator.models.Delivery',
        'devilry.examiner.models.Delivery',
        'devilry.student.models.Delivery',
        'trix_extjshelpers.SingleRecordContainer',
        'trix_extjshelpers.assignmentgroup.DeadlineExpiredNoDeliveriesBox'
    ],
    ...
    initComponent: function() {
        this.assignmentgroup_recordcontainer = Ext.create('trix_extjshelpers.SingleRecordContainer');
        this.delivery_recordcontainer = Ext.create('trix_extjshelpers.SingleRecordContainer');
        this.gradeeditor_config_recordcontainer = Ext.create('trix_extjshelpers.SingleRecordContainer');
...
//                    defaults: {anchor: '100%'},
                    items: [{
                        ...
                        listeners: {
                            scope: this,
                            click: function() {
                                Ext.create('trix_extjshelpers.assignmentgroup.AssignmentGroupTodoListWindow', {
...
//                me.loadAllDeadlines();
    ...
    _onCloseGroup:function () {
        trix_extjshelpers.assignmentgroup.IsOpen.closeGroup(this.assignmentgroup_recordcontainer, function() {
            window.location.reload();
        });
    },
