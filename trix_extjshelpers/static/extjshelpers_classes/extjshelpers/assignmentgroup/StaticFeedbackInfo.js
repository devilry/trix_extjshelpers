 ...
 */
Ext.define('trix_extjshelpers.assignmentgroup.StaticFeedbackInfo', {
    extend: 'Ext.container.Container',
    alias: 'widget.staticfeedbackinfo',
    cls: 'widget-staticfeedbackinfo',
    requires: [
        'trix_extjshelpers.Pager',
        'trix_extjshelpers.SingleRecordContainer',
        'trix_extjshelpers.assignmentgroup.FileMetaBrowserPanel',
        'trix_extjshelpers.assignmentgroup.StaticFeedbackView',
        'trix_extjshelpers.SingleRecordContainerDepButton',
     ...
     * A {@link trix_extjshelpers.SingleRecordContainer} for Delivery.
     */
    ...
    initComponent: function() {
        this.staticfeedback_recordcontainer = Ext.create('trix_extjshelpers.SingleRecordContainer');
