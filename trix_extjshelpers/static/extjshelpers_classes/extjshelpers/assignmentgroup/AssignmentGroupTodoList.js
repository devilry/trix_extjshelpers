Ext.define('trix_extjshelpers.assignmentgroup.AssignmentGroupTodoList', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.assignmentgrouptodolist',
    cls: 'widget-assignmentgrouptodolist',
    requires: [
        'trix_extjshelpers.formfields.StoreSearchField'
    ],
    ...
    /**
    * @cfg
    * A {@link trix_extjshelpers.SingleRecordContainer} for AssignmentGroup. (Optional).
    *
