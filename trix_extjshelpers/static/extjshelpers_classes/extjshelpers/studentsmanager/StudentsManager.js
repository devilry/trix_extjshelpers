Ext.define('trix_extjshelpers.studentsmanager.StudentsManager', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.studentsmanager',
    cls: 'studentsmanager',

    requires: [
        'trix_extjshelpers.studentsmanager.FilterSelector',
        'trix_extjshelpers.studentsmanager.StudentsGrid',
        'trix_extjshelpers.assignmentgroup.MultiCreateNewDeadlineWindow',
        'trix_extjshelpers.SearchField',
        'trix_extjshelpers.SetListOfUsers',
        'devilry.gradeeditors.EditManyDraftEditorWindow',
        'trix_extjshelpers.studentsmanager.MultiResultWindow',
        'trix_extjshelpers.MenuHeader',
        'trix_extjshelpers.HelpWindow',
        'Ext.ux.grid.Printer',
        'trix_extjshelpers.GridPrintButton'
    ],

    mixins: {
        createFeedback: 'trix_extjshelpers.studentsmanager.StudentsManagerCreateFeedback',
        manageDeadlines: 'trix_extjshelpers.studentsmanager.StudentsManagerManageDeadlines',
        closeOpen: 'trix_extjshelpers.studentsmanager.StudentsManagerCloseOpen',
    ...
    */
    ...
    initComponent: function() {
        ...
        this.registryitem_recordcontainer = Ext.create('trix_extjshelpers.SingleRecordContainer');
        this.registryitem_recordcontainer.addListener('setRecord', this.onLoadRegistryItem, this);

        this.progressWindow = Ext.create('trix_extjshelpers.studentsmanager.MultiResultWindow', {
...
//            maximized: true,
    ...
    search: function(searchstring) {
        var parsedSearch = Ext.create('trix_extjshelpers.SearchStringParser', {
