Ext.define('trix_extjshelpers.studentsmanager.StudentsGrid', {
    ...
    requires: [
        'trix_extjshelpers.GridSelectionModel'
    ],
    ...
    mixins: {
        canPerformActionsOnSelected: 'trix_extjshelpers.GridPeformActionOnSelected'
    },
    ...
    initComponent: function() {
        ...
        this.selModel = Ext.create('trix_extjshelpers.GridSelectionModel', {
            checkOnly: false
        });
