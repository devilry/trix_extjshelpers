/**
 * View panel bound to a {@link trix_extjshelpers.SingleRecordContainer}.
 * Kind of like ``Ext.view.View`` only for a single record.
 */
Ext.define('trix_extjshelpers.SingleRecordView', {
    ...
    config: {
        /**
        * @cfg
        * A {@link trix_extjshelpers.SingleRecordContainer} which contains data for the ``tpl``.
        */
