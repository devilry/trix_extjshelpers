/** 
 * REST proxy subclass which handles errors from {@link trix_extjshelpers.RestSubmit}. 
 *
 ...
 *
 * # See also
 * This should be used with {@link trix_extjshelpers.RestSubmit}.
 * */
Ext.define('trix_extjshelpers.RestProxy', {
    ...
    copy: function(options) {
        ...
        var newproxy = Ext.create('trix_extjshelpers.RestProxy', config);
        return newproxy;
    },
    ...
    statics: {
        ...
        showErrorMessagePopup: function(operation, title, message) {
            Ext.MessageBox.show({
                title: title,
                msg: trix_extjshelpers.RestProxy.formatHtmlErrorMessage(operation),
                buttons: Ext.Msg.OK,
                icon: Ext.Msg.ERROR
            });
        }
