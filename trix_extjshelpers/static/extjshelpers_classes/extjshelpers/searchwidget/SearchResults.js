 ...
 * @xtype searchresults
 * */
Ext.define('trix_extjshelpers.searchwidget.SearchResults', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.searchresults',
    requires: [
        'trix_extjshelpers.searchwidget.SearchResultItem',
    ...
    initComponent: function() {
        var me = this;
	console.log("DEBUG: this.store: " + this.store + " should not be undefined");
